...
SW_test <- table %>%
  ...
  shapiro_test(Value)
View(SW_test)
write.table(SW_test, file = "STD_MassBalance_Citrate_ShapiroWilk_test_results.csv", quote = FALSE, sep = ";")
...
write.table(TwoWay_Anova, file = "STD_MassBalance_Citrate_TwoWay_Anova_results.csv", quote = FALSE, sep = ";")

sink("STD_MassBalance_Citrate_TwoWay_Anova_results2.csv")
TwoWay_Anova
sink(NULL)
...
##OneWayAnova save
sink("STD_MassBalance_Citrate_OneWayAnova_Results_Ti.csv")
OneWay_Anova_Ti2 
sink(NULL)
...
sink("STD_MassBalance_Citrate_HSD_Ti.csv")
HSD_Ti_groups 
sink(NULL)
...
##OneWayAnova save
sink("STD_MassBalance_Citrate_OneWayAnova_Results_Tr.csv")
OneWay_Anova_Tr2 
sink(NULL)
...
sink("STD_MassBalance_Citrate_HSD_Tr.csv")
HSD_Tr_groups 
sink(NULL)
